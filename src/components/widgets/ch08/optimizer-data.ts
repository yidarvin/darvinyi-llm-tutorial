...
export const OPTIMIZERS: OptimizerSpec[] = [
  ...
  },
  {
    ...
    label: 'Adam',
    shortLabel: 'Adam',
    description: "Adaptive per-parameter learning rates via second-moment estimate. Per-axis scaling means x gets smaller updates and y gets larger ones, producing a smooth trajectory.",
    color: 'var(--amber-400)',
