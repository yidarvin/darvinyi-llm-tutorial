...
With seed 0, unmasked loss is 5.328 (averaged over all 12 positions) and masked loss is 5.369 (averaged over only the 6 response positions) — different values, confirming the mask actually changes which tokens the gradient sees.
