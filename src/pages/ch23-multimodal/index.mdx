...
<RunnableCode client:visible expectedOutput={["Visual tokens shape:  (196, 768)", "Number of tokens:     196"]}>
```python
import numpy as np
...
<RunnableCode client:visible expectedOutput={["Image-to-text contrastive loss: 0.0025"]}>
```python
import numpy as np
...
<RunnableCode client:visible expectedOutput={["txt_cat_care        How to care for an orange tabby cat", "img_cat             a fluffy orange cat"]}>
```python
import numpy as np
