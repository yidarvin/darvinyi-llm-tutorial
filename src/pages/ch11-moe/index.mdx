...
<RunnableCode client:visible expectedOutput={["Aux loss: 0.01001", "Aux loss: 0.03841"]}>
```python
import numpy as np
...
<RunnableCode client:visible expectedOutput={["Total params:  47.2B", "Active params: 13.4B"]}>
```python
