...
$f_i$ is a hard count (from argmax assignments), $P_i$ is a soft average (from the full softmax) — mixing a hard and soft signal is what makes this loss differentiable despite argmax being involved:
