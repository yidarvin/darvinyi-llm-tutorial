...
import EmbeddingSpace from '@components/widgets/ch02/EmbeddingSpace';
import Word2VecDynamics from '@components/widgets/ch02/Word2VecDynamics';
...
The *why* gets a clean partial answer from Levy and Goldberg (2014, [NeurIPS](https://papers.nips.cc/paper/5477-neural-word-embedding-as-implicit-matrix-factorization)). They showed that the SGNS objective <EqRef id="2.sgns" /> is implicitly factorizing a matrix, specifically the shifted pointwise mutual information matrix:
...
Word2vec is the historical anchor for this material. It is not, however, how the embeddings inside a modern LLM are trained.
