...
<WidgetFrame title="BPE training" caption="Watch BPE learn merges step by step on a small corpus. Each step picks the most frequent adjacent pair; the vocabulary grows by one token each iteration.">
...
<WidgetFrame title="Compare tokenizers" caption="Type any text and see how it breaks into tokens under several real tokenizers. Numbers, non-English text, and code show the largest differences.">
  <div style={{ aspectRatio: '16 / 9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.875rem' }}>
