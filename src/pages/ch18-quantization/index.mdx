...
import QuantizationExplorer from '@components/widgets/ch18/QuantizationExplorer';
import GranularityVisualizer from '@components/widgets/ch18/GranularityVisualizer';
...
<RunnableCode client:visible expectedOutput={["0.0013948", "0.0003058", "x_min quantizes to integer -128 (should equal qmin = -128)"]}>
```python
import numpy as np
...
<RunnableCode client:visible expectedOutput={["0.00000033", "0.00009697", "INT8: nearly indistinguishable from FP32 (MSE ~1e-7)"]}>
```python
import numpy as np
...
<RunnableCode client:visible expectedOutput={["Per-tensor                   |     0.007940", "Per-group (G=64)             |     0.000251"]}>
```python
import numpy as np
...
<RunnableCode client:visible packages={["numpy", "scipy"]} expectedOutput={["-1.0000  -0.6962  -0.5251  -0.3949", "Ratio (tail / center): 3.82x coarser in tails"]}>
```python
import numpy as np
