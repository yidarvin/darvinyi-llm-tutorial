...
`}
  packages={[]}
  expectedOutput={["Original: 5 docs  →  Exact-deduped: 3 docs", "Removed: 2 exact duplicates of doc 0."]}
  height={420}
/>
...
`}
  packages={["numpy"]}
  expectedOutput={["True Jaccard:     0.929", "standard error ≈ 0.035 at J=0.5 with 200 hash functions"]}
  height={560}
/>
...
`}
  packages={[]}
  expectedOutput={["too repetitive", "wrong language", "too short/long"]}
  height={520}
/>
...
`}
  packages={[]}
  expectedOutput={["[CONTAMINATED] doc 1", "[safe        ] doc 2"]}
  height={440}
/>
