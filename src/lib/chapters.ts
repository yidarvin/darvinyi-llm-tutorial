...
export const PARTS: Part[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: 6, slug: 'ch06-positional-encoding', title: 'Positional encoding', partNum: 2, status: 'published' },
    ],
  },
  {
    num: 3,
    ...
    chapters: [
      ...
      { num: 8,  slug: 'ch08-building-small-llm',  title: 'Building a small LLM',               partNum: 3, status: 'published' },
      { num: 9,  slug: 'ch09-scaling-and-distributed', title: 'Scaling laws & distributed training', partNum: 3, status: 'published' },
      { num: 10, slug: 'ch10-training-infra',      title: 'Training infrastructure',            partNum: 3, status: 'published' },
    ],
  },
  {
    num: 4,
    ...
    chapters: [
      ...
      { num: 12, slug: 'ch12-ssm-and-mamba', title: 'State-space models & Mamba', partNum: 4, status: 'published' },
    ],
  },
  {
    num: 5,
    ...
    chapters: [
      ...
      { num: 14, slug: 'ch14-alignment',    title: 'Alignment (RLHF, DPO, RLVR, CAI)',        partNum: 5, status: 'published' },
      { num: 15, slug: 'ch15-peft',         title: 'Parameter-efficient fine-tuning',         partNum: 5, status: 'published' },
      { num: 16, slug: 'ch16-distillation', title: 'Distillation',                            partNum: 5, status: 'published' },
    ],
  },
  {
    num: 6,
    ...
    chapters: [
      ...
      { num: 18, slug: 'ch18-quantization',           title: 'Quantization & compression', partNum: 6, status: 'published' },
      { num: 19, slug: 'ch19-sampling',               title: 'Sampling & decoding',      partNum: 6, status: 'published' },
    ],
  },
  {
    num: 7,
    ...
    chapters: [
      ...
      { num: 21, slug: 'ch21-tool-use',          title: 'Tool use',                      partNum: 7, status: 'published' },
      { num: 22, slug: 'ch22-retrieval-and-rag', title: 'Retrieval & RAG',               partNum: 7, status: 'published' },
      { num: 23, slug: 'ch23-multimodal',        title: 'Multimodal',                    partNum: 7, status: 'published' },
    ],
  },
  {
    num: 8,
    ...
    chapters: [
      ...
      { num: 26, slug: 'ch26-evaluation',       title: 'Evaluation',          partNum: 8, status: 'published' },
    ],
  },
  {
    num: 9,
    title: 'Agents',
    chapters: [
      { num: 27, slug: 'ch27-agent-foundations',          title: 'Agent foundations',               partNum: 9, status: 'published' },
      { num: 28, slug: 'ch28-agent-from-scratch',         title: 'Building an agent from scratch',  partNum: 9, status: 'published' },
      { num: 29, slug: 'ch29-multi-agent',                title: 'Multi-agent systems',             partNum: 9, status: 'published' },
      { num: 30, slug: 'ch30-agent-eval-and-frameworks',  title: 'Agent evaluation & frameworks',   partNum: 9, status: 'published' },
    ],
  },
];
