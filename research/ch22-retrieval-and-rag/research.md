...
**Phase 13 progression**: Ch 22 is the third of four Phase 13 chapters. **Reasoning (Ch 20) gave the model time to think; tool use (Ch 21) gave it the ability to act; retrieval (this chapter) gives it the ability to know what it wasn't trained on.** After this: Ch 23 (Multimodal) extends to non-text modalities; then Phase 14 (Safety/Interp/Eval); then Phase 15 (Agents).
